...
The plugin connects Cursor to your running Encore app via the [Model Context Protocol](https://modelcontextprotocol.io). This gives the agent live context about your application:
...
4. Run `encore run` to start your app — the MCP server needs the app running to provide trace data, database access, and endpoint testing
